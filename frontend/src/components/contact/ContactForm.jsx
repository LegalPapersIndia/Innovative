...
const ContactForm = () => {
  ...
  return (
    <section className="py-16 sm:py-24 bg-linear-to-b from-white to-[#faf8f2]">
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="group w-full bg-green-950 text-white py-3 rounded-xl font-semibold inline-flex items-center justify-center gap-2 hover:bg-green-900 transition-all duration-300 disabled:opacity-60"
                  >
