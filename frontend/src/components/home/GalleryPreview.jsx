...
// const images = [
//   { src: img1, span: "row-span-2", caption: "Harvest Day" },
//   { src: img2, span: "row-span-1", caption: "Grading & Sorting" },
//   { src: img3, span: "row-span-1", caption: "Processing Line" },
//   { src: img4, span: "row-span-1", caption: "Quality Check" },
//   { src: img5, span: "row-span-2", caption: "Export Packaging" },
//   { src: img6, span: "row-span-1", caption: "Container Loading" },
// ];
