...
//   return (
//     <section className="relative pt-32 pb-16 sm:pt-40 sm:pb-20 bg-cream overflow-hidden" style={{ backgroundColor: "#faf8f2" }}>
...
//           className="flex items-center gap-2 text-green-700/60 text-sm mb-10"
//         >
...
//             </div>
//             {product.tag && (
//               <span className="absolute top-6 left-6 px-4 py-1.5 rounded-full bg-amber-400 text-green-950 text-xs font-semibold tracking-wide shadow-lg">
//                 {product.tag}
//               </span>
//             )}
//           </motion.div>
...
//             <h1 className="font-display text-4xl sm:text-5xl font-medium text-green-950 leading-tight mb-6">
//               {product.name}
//             </h1>
